...
public class AdminPanel {
    ...
    public void userManagementOptions() {
        while (true) {
            ...
            switch (choice) {
                ...
                case 5 -> bikeRental.simulateApplicationInput();
    ...
    private void addNewUsers() {
        ...
        for (int i = 1; i <= userNumber; i++) {
            ...
            System.out.println(
                    "Please enter the card number(only Visa, MasterCard, and American Express cards are accepted):");
            ...
            for (int j = 0; j < 3; j++) {
                ...
                tripInformation.append("Date: ").append(dateOfTrip).append(", Source: ").append(sourceAndDestination)
